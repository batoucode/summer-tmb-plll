...
vues par rôle, `9x` = démarrage. Les trous entre les tranches sont
volontaires — un futur `80-view-settings.js` par exemple s'insère
proprement sans tout renuméroter.
